...
class _Login:
    ...
    def jd_m(self):
        ...
        login = WebDriverWait(self.driver, 5).until(
            lambda driver: driver.find_element_by_xpath('//*[@id="index_searchLogin"]'))
        login.click()
        QQ = WebDriverWait(self.driver, 5).until(
            lambda driver: driver.find_element_by_xpath('//a[@report-eventid="MLoginRegister_QQLogin"]'))
        QQ.click()
