...
from cuckoo.settings import CHROME_DATA
...
class Lazada(Spider):
    ...
    custom_settings={
        ...
        'DOWNLOADER_MIDDLEWARES': {
            'cuckoo.utils.middlewares.ProxiesMiddleware': 400,
        },
        'ITEM_PIPELINES': {
            # 'cuckoo.pipelines.MongoPipeline': 299,  #该pipeline优先级应大于Sqlpipeline
            'cuckoo.pipelines.SqlPipeline': 300,
        },
    }
